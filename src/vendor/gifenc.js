/*! gifenc 1.0.3 — https://github.com/mattdesl/gifenc — MIT License (see gifenc.LICENSE.md)
 * Vendored from the npm CommonJS build and wrapped to expose window.gifenc for classic <script> use (no bundler). */
(function () {
var exports = {};
