/*! mp4-muxer 5.2.2 — https://github.com/Vanilagy/mp4-muxer — MIT License (see mp4-muxer.LICENSE.md)
 * Vendored verbatim from the npm package's browser global build (build/mp4-muxer.js), which declares
 * `var Mp4Muxer` (-> window.Mp4Muxer: Muxer, ArrayBufferTarget, ...) for classic <script> use (no bundler).
 * Only change: this header. The package is deprecated in favour of Mediabunny; kept for its size/licence. */
"use strict";
var Mp4Muxer = (() => {
